    ...
    <div className="min-h-screen bg-[#FAF8F5] text-[#1E293B] font-sans selection:bg-[#D97706]/20 selection:text-[#1D3B3A]">
      ...
      <section className="relative pt-12 pb-24 overflow-hidden min-h-[650px] bg-[#FAF8F5]">
        ...
        <div className="mx-auto max-w-7xl px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <motion.div
            ...
            animate="visible"
          >
            <motion.h1 variants={fadeInUp} className="text-4xl sm:text-5xl lg:text-6xl font-serif font-extrabold text-[#0F172A] leading-[1.15] tracking-tight">
              Turn Chaotic Bookings into Beautiful Journeys.
            </motion.h1>
            <motion.p variants={fadeInUp} className="text-lg text-[#475569] leading-relaxed max-w-xl">
            ...
            <motion.div variants={fadeInUp} className="flex flex-wrap items-center gap-4">
              <button
                ...
                className="bg-[#1D3B3A] hover:bg-[#162E2D] text-white font-medium px-7 py-3.5 rounded-xl shadow-md hover:shadow-lg transition-all flex items-center gap-2 cursor-pointer hover:-translate-y-0.5"
              >
              ...
              <a
                href="#how-it-works"
                className="text-sm font-semibold text-[#475569] hover:text-[#1D3B3A] px-4 py-3.5 flex items-center gap-1.5 transition-colors"
              >
            ...
            {/* Feature Badge Pill */}
            <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 border border-[#EBE7DF] bg-[#FFFDF9] px-4 py-2 rounded-full text-xs font-semibold text-[#64748B] shadow-2xs">
      ...
      <section id="features" className="py-20 bg-[#FFFDF9] border-y border-[#EBE7DF]">
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            {/* Feature 1 */}
            <motion.div variants={fadeInUp} className="bg-[#FAF8F5] border border-[#EBE7DF] rounded-2xl p-8 space-y-4 hover:shadow-lg hover:-translate-y-1 transition-all">
      ...
      <section id="how-it-works" className="py-20 bg-[#FAF8F5]">
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            {/* Step 1 */}
            <motion.div variants={fadeInUp} className="bg-[#FFFDF9] border border-[#EBE7DF] rounded-2xl p-6 flex items-start gap-4 shadow-2xs hover:shadow-md transition-all">
              <div className="w-10 h-10 rounded-full bg-[#1D3B3A] text-white font-bold flex items-center justify-center shrink-0">
                1
              </div>
              <div>
      ...
      <section id="demo" className="py-20 bg-[#FFFDF9] border-t border-[#EBE7DF]">
        <div className="mx-auto max-w-7xl px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-5 space-y-6">
            ...
            <button
              onClick={handleTryDashboard}
              className="bg-[#1D3B3A] hover:bg-[#162E2D] text-white font-medium px-6 py-3 rounded-xl shadow-sm transition-all flex items-center gap-2 cursor-pointer hover:scale-102"
            >
              <span>Try Dashboard</span>
              <ArrowRight className="w-4 h-4" />
            </button>
          ...
          >
            ...
            <div className="flex items-center justify-between border-b border-[#EBE7DF] pb-3 mb-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-2xs font-bold text-[#0F172A]">Aarav Sharma</span>
              </div>
            </div>
